...
const struct debug_strings dwr_ike_delete_array[] = {
	{ IKE_DELETE_RESERVED,	" (IKE_DELETE_RESERVED)" },
	...
	{ IKE_DELETE_SERVER_IN_FLAMES,	" (IKE_DELETE_SERVER_IN_FLAMES)" },
	...
	{ IKE_DELETE_CLIENT_NOT_ALLOWED,	" (IKE_DELETE_CLIENT_NOT_ALLOWED)" },
	{ IKE_DELETE_FW_SERVER_FAIL,	" (IKE_DELETE_FW_SERVER_FAIL)" },
	{ IKE_DELETE_ACL_ERROR,	" (IKE_DELETE_ACL_ERROR)" },
	{ 0,	(const char *) 0 }
};
...
const struct debug_strings ike_group_enum_array[] = {
	...
	// { IKE_GROUP_MODP_3072,	" (IKE_GROUP_MODP_3072)" },
	// { IKE_GROUP_MODP_4096,	" (IKE_GROUP_MODP_4096)" },
	// { IKE_GROUP_MODP_6144,	" (IKE_GROUP_MODP_6144)" },
	// { IKE_GROUP_MODP_8192,	" (IKE_GROUP_MODP_8192)" },
	{ 0,	(const char *) 0 }
};
